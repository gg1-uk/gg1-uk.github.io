...
<p style="font-size:16px; font-style:italic;">Read: 3mins, watch: 10mins, updated 23-Jul-24 10:43am live.</p>
...
All in all, it's strongly recommended to have the redundance and resilience capabilities in the network connectivity implementation between on-premises and Sentinel. However, in the event of all failures (touch woods), we are prepared and aware what to lookout for symptoms and action to achieve a 100% recovery plan.
